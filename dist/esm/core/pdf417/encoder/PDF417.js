...
var PDF417 = /** @class */ (function () {
    ...
    /*int*/ errorCorrectionLevel, autoECI) {
        ...
        var errorCorrectionCodeWords = PDF417ErrorCorrection.getErrorCorrectionCodewordCount(errorCorrectionLevel);
        var highLevel = PDF417HighLevelEncoder.encodeHighLevel(msg, this.compaction, this.encoding, autoECI);
        ...
        if (sourceCodeWords + errorCorrectionCodeWords + 1 > 929) {
            ...
            throw new WriterException('Encoded message contains too many code words, message too big (' +
                msg.length +
                ' bytes)');
        }
        ...
        var ec = PDF417ErrorCorrection.generateErrorCorrection(dataCodewords, errorCorrectionLevel);
