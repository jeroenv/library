...
var Code128Writer = /** @class */ (function (_super) {
    ...
    Code128Writer.check = function (contents, hints) {
        ...
        if (hints != null && hints.has(EncodeHintType.FORCE_CODE_SET)) {
            var codeSetHint = hints.get(EncodeHintType.FORCE_CODE_SET).toString();
            switch (codeSetHint) {
                case 'A':
    ...
    /*int*/ forcedCodeSet) {
        ...
        while (position < length) {
            ...
            // Get the pattern
            patterns.push(__spreadArray([], __read(Code128Reader.CODE_PATTERNS[patternIndex]), false));
            // Compute checksum
    ...
    /*int*/ checkSum) {
        ...
        checkSum %= 103;
        patterns.push(__spreadArray([], __read(Code128Reader.CODE_PATTERNS[checkSum]), false));
        // Append stop code
        patterns.push(__spreadArray([], __read(Code128Reader.CODE_PATTERNS[Code128Writer.CODE_STOP]), false));
        // Compute code width
        var codeWidth = 0;
        try {
...
/*private static final*/ var MinimalEncoder = /** @class */ (function () {
    ...
    /*int*/ position) {
        ...
        var /*int*/ minCost = Integer.MAX_VALUE;
